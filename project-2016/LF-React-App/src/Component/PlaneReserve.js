...
import styles from '../Style/planeReserve.css';
...
export default class PlaneBook extends Component{
  ...
  bookQuick(){
    ...
    this.connectWebViewJavascriptBridge(bridge =>{
      bridge.callHandler('subInfo',{'data' : {
          "subInfo" : c
       }}, function(response) {
  ...
  render(){
    ...
    return(
      <div>
        <PickPlane bookQuick={this.bookQuick} />
    ...
    return(
      ...
      <form id="form2">
        <div className="pick pick1">
          <p></p>
          <h3><input ref="start_city" name="start_city" type="text" placeholder="起飞地点" style={{"textAlign":"center"}}  /></h3>
        </div>
        <div className="pick pick2">
          <p className="ic-to"></p>
          <h3><input ref="end_city" name="end_city" type="text" placeholder="降落地点" style={{"textAlign":"center"}}  /></h3>
        </div>
        </form>
      </div>
    );
    ...
    return(
        <div className="form0">
          <form id="form">
            ...
            <p><span></span><input type="text" placeholder="请输入姓名" name="username" /></p>
            <p><span></span><input type="tel" placeholder="请输入手机号" name="user_tel" maxLength='11' /></p>
            <p><span></span>
