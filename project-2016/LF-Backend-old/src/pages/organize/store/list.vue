        ...
        <div class='contant'>
            <div class='fadeInRight'>
                <v-search>
                    ...
                    <input type="text" placeholder='请输入门店负责人姓名'>
                    <input type="text" placeholder='业务员姓名（拉风）'>
                    <input type="button" value='搜索' @click='submit'>
                </v-search>
                <v-form :page='true' createname='创建门店' :labelData='labelData'
...
<script>
  ...
  export default {
    ...
    beforeMount () {
      this.labelData = labelData['organize.store']
    },
    created () {
      this.fetchData(1)
    }
